...
export default function DayronGiro() {
  const designer = {
    ...
    image: "/placeholder.svg?height=600&width=800&text=Dayron+Giro+Design",
    avatar: "/placeholder.svg?height=100&width=100&text=DG",
    content: `
      ...
      <blockquote>
        <p>"El diseño debe ser funcional, pero también debe emocionar y contar historias"</p>
        <cite>- Dayron Giro</cite>
      </blockquote>
